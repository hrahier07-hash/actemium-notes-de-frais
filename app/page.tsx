  ...
  return (
    <div className="acm-shell">
      ...
      <style>{`
        ...
        /* Mobile: month-header stacks */
        @media (max-width: 640px) {
          .acm-month-header { flex-direction: column !important; align-items: flex-start !important; }
          .acm-month-controls { flex-wrap: wrap !important; }
          ...
          .acm-topbar span:last-child { display: none; }
          .acm-emp-row { flex-wrap: wrap; gap: 8px !important; }
          .acm-emp-row > div:first-child { flex: 1 1 100%; }
          .acm-emp-row > div:last-child { flex-shrink: 0; }
        }
      `}</style>
    </div>
  )
