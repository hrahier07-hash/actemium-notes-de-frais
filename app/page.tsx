  ...
  return (
    <div className="acm-shell">
            ...
            {tab === 'saisie' && (
              <div className="acm-saisie-layout">
                <div style={S.card}>
                  ...
                  <div className="acm-grid2" style={{ alignItems: 'start' }}>
                  ...
                  <div className="acm-grid2" style={{ marginBottom: 16, alignItems: 'start' }}>
                    <div>
                      <label style={S.label}>Commentaire <span style={{ color: 'var(--text3)', fontWeight: 400, textTransform: 'none', letterSpacing: 0, fontSize: 11 }}>(vide = auto)</span></label>
                ...
                {monthMeals.length === 0 ? (
                  ...
                  return (
                    <div style={S.card}>
                      ...
                      {/* ── En-têtes colonnes ── */}
                      <div style={{ display: 'grid', gridTemplateColumns: '180px 72px 72px 72px 1fr', gap: 12, padding: '8px 12px 10px', borderBottom: '1.5px solid var(--border)', fontSize: 11, fontWeight: 600, textTransform: 'uppercase' as const, letterSpacing: '.06em', color: 'var(--primary)' }}>
                        {([
                      ...
                      {visibleEmps.map((e) => {
                        ...
                        return (
                          <div key={e.id} style={{ display: 'grid', gridTemplateColumns: '180px 72px 72px 72px 1fr', gap: 12, alignItems: 'center', padding: '14px 12px', borderBottom: '1px solid var(--border)', transition: 'background .15s' }}
                      ...
                      {visibleEmps.length > 0 && (
                        <div style={{ display: 'grid', gridTemplateColumns: '180px 72px 72px 72px 1fr', gap: 12, alignItems: 'center', padding: '12px 12px', borderTop: '2px solid var(--primary)', background: 'var(--primary-light)', borderRadius: '0 0 12px 12px' }}>
      ...
      <style>{`
        ...
        .acm-nav-item { transition: background 150ms ease, color 150ms ease; }
