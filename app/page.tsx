    ...
    <div className="acm-shell">
      ...
      <aside className="acm-sidebar">
        <div className="acm-sidebar-logo">
          <img src={LOGO_SRC} alt="Actemium" style={{ height: 50, width: 'auto', filter: 'drop-shadow(0 2px 8px rgba(50,130,222,0.15))' }} />
...
const S = {
  ...
  tableHead: { display: 'grid', gridTemplateColumns: 'clamp(90px,10%,130px) 1fr clamp(70px,8%,100px) 1fr clamp(60px,7%,80px)', gap: 12, padding: '10px 14px 12px', borderBottom: '1px solid var(--border)', fontSize: 11, fontWeight: 700, color: 'var(--text3)', textTransform: 'uppercase', letterSpacing: '.08em' } as React.CSSProperties,
  tableRow: { display: 'grid', gridTemplateColumns: 'clamp(90px,10%,130px) 1fr clamp(70px,8%,100px) 1fr clamp(60px,7%,80px)', gap: 12, alignItems: 'center', padding: '13px 14px', borderBottom: '1px solid var(--border)', transition: 'background .1s' } as React.CSSProperties,
